...
También genera el resumen diario con deepseek-v4-flash de NaN.
...
# prefijo de letra o número puro de 3-4 dígitos).
...
def main():
    ...
    # Partes de "Actualización de afectaciones": MW del déficit y horas declaradas
    # por CIRCUITO ("✅R454 - 27 horas y 33 minutos") -> [fecha, codigo, horas].
